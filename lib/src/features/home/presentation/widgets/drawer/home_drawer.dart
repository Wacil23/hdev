    ...
    return BlocBuilder<HomeContractBloc, HomeContractState>(
      builder: (context, state) {
        if (state is HomeContractDone) {
          final String? firstName = state.contracts?.prenomLocataire;
          final String? lastName = state.contracts?.nomLocataire;
          return Drawer(
            backgroundColor: const Color.fromARGB(255, 18, 67, 136),
            child: Column(
              children: [
                DrawerHeader(
                        ...
                        ListTile(
                          ...
                          onTap: () {
                            if (state.contracts != null) {
                              Navigator.of(context).pushNamed('/contrat',
                                  arguments: state.contracts);
                            }
                          },
                        ),
                      ],
